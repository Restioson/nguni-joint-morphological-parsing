...
def train(model, cfg, name: str, train_dataset: TransformerDataset, valid_dataset: TransformerDataset, device: torch.device, evaluation_alignment: SequenceAlignment=SequenceAlignment.PADDING_END, use_ray=False):
