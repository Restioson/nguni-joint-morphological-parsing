...
from ..common import (TaggingDataset, tune_model, tokenize_into_morphemes, EmbedSingletonFeature, split_sentences,
                      train_all)
...
def final_train():
    ...
    train_all(data_dir, model, splits, feature_level, cfg, add_valid_to_training_set=False)
